...
@router.get("/policy-report", response_model=ReleaseGatePolicyReportResponse)
async def get_release_gate_policy_report(
    dataset_name: str = "",
    experiment_name: str = "",
    ...
    return release_gate_service.get_policy_report(
        db=db,
        workspace_id=workspace_id,
